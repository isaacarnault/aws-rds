...
The following gist is intended to anyone looking to launch a `Wordpress` blog or website on `AWS`.<br>
We gonna be using `Amazon RDS` (Amazon Relational Database Service) as well as an `EC2 instance`.<br>
